...
import { ArrowRight, Bot, Puzzle, Shield, Sparkles } from "lucide-react";
	...
	return (
		<div ref={pageRef}>
			...
			<section className="grain-overlay relative overflow-hidden border-b border-border/40">
				<div className="container mx-auto flex flex-col px-4 py-24 lg:py-32">
					<div className="grid gap-12 lg:grid-cols-12">
						<div className="lg:col-span-7">
							<span className="label-caps text-brand">
								{t("hero.badge")}
							</span>
							<h1 className="mt-6 font-display text-5xl tracking-tight sm:text-6xl lg:text-7xl" style={{ lineHeight: 1.1 }}>
								<span className="block">{t("hero.title.line1")}</span>
								<span className="block">
									<em className="text-brand">{t("hero.title.line2")}</em>
								</span>
							</h1>
							<p className="mt-8 max-w-xl text-lg text-muted-foreground" style={{ lineHeight: 1.7 }}>
								{t("hero.subtitle")}
							</p>
						...
						<div className="hidden items-center justify-center lg:col-span-5 lg:flex">
							<div className="relative flex h-64 w-64 items-center justify-center">
								...
								<div className="absolute inset-4 rounded-full bg-brand/10" />
								<Sparkles className="h-20 w-20 text-brand" strokeWidth={1} />
							</div>
						</div>
					</div>
				</div>
			...
			<section className="border-b border-border/40">
				<div className="container mx-auto px-4 py-20">
					<div className="flex items-end justify-between">
						...
						<Link
							href="/catalogue"
							className="label-caps hidden items-center gap-2 text-brand transition-colors hover:text-brand-dark md:flex"
						>
